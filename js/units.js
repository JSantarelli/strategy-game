const availableUnits = [
  ...
  { id: 'arg03', name: "Mirage III", firePower: 75, fireScope: 7, displacement: 8, stamina: 50, shield: 30, totalStamina: 100, cost: 11000, type: "aircraft", team: "arg", imgPath: 'arg-mirage.png', span: { columns: 100, rows: 100 } },
  { id: 'arg04', name: "Dessault V Dagger", firePower: 70, fireScope: 6, displacement: 7, stamina: 50, shield: 30, totalStamina: 100, cost: 10000, type: "aircraft", team: "arg", imgPath: 'arg-dagger-2.png', span: { columns: 100, rows: 100 } },
  ...
  { id: 'arg11', name: "FN MAG", firePower: 50, fireScope: 4, displacement: 2, stamina: 30, shield: 10, totalStamina: 40, cost: 3000, type: "support", team: "arg", imgPath: 'arg-mag.png', span: { columns: 100, rows: 100 } },
  { id: 'arg11', name: "FH-70", firePower: 50, fireScope: 4, displacement: 2, stamina: 30, shield: 10, totalStamina: 40, cost: 3000, type: "support", team: "arg", imgPath: 'arg-fh-70.png', span: { columns: 100, rows: 100 } },
  
  // Blindados y Vehículos Terrestres
  { id: 'arg23', name: "Panhard AML-90", firePower: 65, fireScope: 5, displacement: 6, stamina: 55, shield: 25, totalStamina: 80, cost: 8000, type: "armor", team: "arg", imgPath: 'arg-panhard.png', span: { columns: 100, rows: 100 } },
  { id: 'arg24', name: "M-113", firePower: 50, fireScope: 4, displacement: 5, stamina: 65, shield: 30, totalStamina: 95, cost: 9000, type: "armor", team: "arg", imgPath: 'arg-m-113.png', span: { columns: 100, rows: 100 } },
  { id: 'arg25', name: "Anfibio LVTP-7113", firePower: 50, fireScope: 4, displacement: 5, stamina: 65, shield: 30, totalStamina: 95, cost: 9000, type: "armor", team: "arg", imgPath: 'arg-anfibio.png', span: { columns: 100, rows: 100 } },
  
  // Defensa Antiaérea
  { id: 'arg12', name: "Roland SAM", firePower: 90, fireScope: 8, displacement: 3, stamina: 50, shield: 40, totalStamina: 90, cost: 12000, type: "anti-air", team: "arg", imgPath: 'arg-roland.png', span: { columns: 100, rows: 100 } },
  { id: 'arg13', name: "Bofors", firePower: 75, fireScope: 6, displacement: 2, stamina: 45, shield: 25, totalStamina: 70, cost: 9000, type: "anti-air", team: "arg", imgPath: 'arg-bofors.png', span: { columns: 100, rows: 100 } },
  { id: 'arg11', name: "Lanzador Exocet", firePower: 50, fireScope: 4, displacement: 2, stamina: 30, shield: 10, totalStamina: 40, cost: 3000, type: "anti-air", team: "arg", imgPath: 'arg-lanzador-exocet.png', span: { columns: 100, rows: 100 } },
  ...
  // UK
  {
    ...
    { id: 'uk05', name: "Westland Sea King", firePower: 30, fireScope: 3, displacement: 6, stamina: 60, shield: 30, totalStamina: 90, cost: 9000, type: "aircraft", team: "uk", imgPath: 'uk-sea-king.png', span: { columns: 100, rows: 100 } },
    ...
    // Blindados y Vehículos Terrestres
    { id: 'uk04', name: 'FV101 Scorpion', firePower: 70, fireScope: 5, displacement: 7, stamina: 60, shield: 30, totalStamina: 90, cost: 10000, type: 'armor', team: 'uk', imgPath: 'uk-fv101-scorpion.png', span: { columns: 100, rows: 100 } },
